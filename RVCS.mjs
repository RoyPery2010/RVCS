...
class RVCS {
    ...
    constructor(repoPath = '.') {
        this.repoPath = path.join(repoPath, '.rvcs');
        this.objectsPath = path.join(this.repoPath, 'objects'); // .rvcs/objects
        this.headPath = path.join(this.repoPath, 'HEAD'); // .rvcs/HEAD
        this.indexPath = path.join(this.repoPath, 'index'); // .rvcs/index
        this.init();
    }
    ...
    async init() {
        ...
        try {
            ...
            console.log("Already initialised the .rvcs/folder");
        }
    }
    ...
    async add(fileToBeAdded) {
        ...
        const newFileHashedObjectPath = path.join(this.objectsPath, fileHash); // .rvcs/objects/abc123
...
// (async () => {
//     const rvcs = new RVCS();
//     // await rvcs.add('sample.txt');
//     // await rvcs.add('sample2.txt');
//     // await rvcs.commit('4th commit');

//     // await rvcs.log();
//     await rvcs.showCommitDiff('7b9d7266145f34073d310f02d42568c6c3213bb4');
// })();
...
program.command('show <commitHash>').action(async (commitHash) => {
    const rvcs = new RVCS();
    await rvcs.showCommitDiff(commitHash);
});
